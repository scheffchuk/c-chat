...
export function AppSidebar() {
  ...
  const sidebarContent = (
    <>
      ...
      <button
        ...
        className="bg-secondary hover:bg-accent text-sm flex w-full items-center justify-center gap-2 rounded-lg py-2 transition-colors duration-200"
      >
        <PlusIcon size={16} />
        New Chat
      </button>
      ...
      <nav className="flex flex-1 flex-col gap-1 overflow-y-auto">
        ...
        <div className="mt-2 mb-2">
          <button className="hover:bg-accent text-muted-foreground text-xs flex w-full items-center gap-2 rounded-lg px-3 py-2 transition-colors duration-200">
            <ClockIcon size={14} />
            <span>Recent</span>
          </button>
        </div>
        ...
        <div className="space-y-1">
          {[
            ...
            <button
              key={index}
              id={`recent-${index}`}
              className="hover:bg-accent text-xs group flex w-full items-center justify-between rounded-lg px-3 py-2 text-left transition-colors duration-200"
            >
  ...
  return (
    ...
    >
      ...
      <div
        className={twMerge(
          "sidebar-wrapper border-foreground/30 absolute left-0 h-full w-full rounded-lg transition-all duration-200 ease-in-out",
          isCollapsed &&
